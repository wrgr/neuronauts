"""
Definitive Large-Scale Multimodal Connectome Benchmark (EXP-020).
Evaluates 150 real proofread Minnie65 pyramidal neurons (450 fragments) with 100+ injected frankenmerges
under strict 3-way inductive protocol (Train 60%, Val 20%, Held-Out Test 20%).
Computes Pairwise ARI, Bar 1 (Precision), Bar 2 (Recall), Bar 3 (Frankenmerge Split),
Path-Weighted Precision/Recall, Expected Run Length (ERL), and Line Graph Circuit Suites.
"""
...
def run_definitive_benchmark():
    print("=" * 120)
    print("DEFINITIVE LARGE-SCALE MULTIMODAL CONNECTOME BENCHMARK (150 REAL MINNIE65 NEURONS, 450 FRAGMENTS)")
    print("=" * 120)
    ...
    # 2. Inject realistic adjacent membrane-contact frankenmerges across volume
    ...
    # 3. Strict 3-Way Inductive Partition (60% Train, 20% Val, 20% Held-Out Test)
    ...
    # Dynamic Threshold Calibration (Derived strictly from train set)
    ...
    print("\n[4/4] Blind Evaluation on Untouched Held-Out Test Partition (30 Neurons, 90 Fragments)...")
    ...
    base_path = compute_path_length_metrics(base_map, gt_map, test_frags_geo)
    ...
    geo_path = compute_path_length_metrics(res_geo.fragment_to_neuron, gt_map, test_frags_geo)
    ...
    multi_path = compute_path_length_metrics(res_multi.fragment_to_neuron, gt_map, test_frags_multimodal)

    # 4. Calibrated Hierarchical Assembly (EXP-020)
    ...
    hier_path = compute_path_length_metrics(res_hier.fragment_to_neuron, gt_map, test_frags_multimodal)
    ...
    print("\n" + "=" * 120)
    print("EXACT MEASURED BLIND HELD-OUT TEST SCORECARD (30 UNSEEN REAL MINNIE65 NEURONS, 90 FRAGMENTS)")
    print("=" * 120)
    print(f"{'Metric':<32} {'Baseline v117':<16} {'Geometry + DNA':<18} {'Flat Multimodal':<20} {'EXP-020 Hierarchical':<26}")
    print("-" * 120)
    print(f"{'Pairwise Out-of-Sample ARI':<32} {base_m['ari']:>14.4f}  {geo_m['ari']:>16.4f}  {multi_m['ari']:>18.4f}  {hier_m['ari']:>24.4f}")
    print(f"{'Pairwise Merge Precision (Bar 1)':<32} {base_m['merge_P']:>14.4f}  {geo_m['merge_P']:>16.4f}  {multi_m['merge_P']:>18.4f}  {hier_m['merge_P']:>24.4f}")
    print(f"{'Pairwise Merge Recall (Bar 2)':<32} {base_m['merge_R']:>14.4f}  {geo_m['merge_R']:>16.4f}  {multi_m['merge_R']:>18.4f}  {hier_m['merge_R']:>24.4f}")
    print(f"{'Frankenmerge Split Rate (Bar 3)':<32} {base_fk:>14.4f}  {geo_fk:>16.4f}  {multi_fk:>18.4f}  {hier_fk:>24.4f}")
    print("-" * 120)
    print(f"{'Path-Weighted Precision (path_P)':<32} {base_path['path_P']:>14.4f}  {geo_path['path_P']:>16.4f}  {multi_path['path_P']:>18.4f}  {hier_path['path_P']:>24.4f}")
    print(f"{'Path-Weighted Recall (path_R)':<32} {base_path['path_R']:>14.4f}  {geo_path['path_R']:>16.4f}  {multi_path['path_R']:>18.4f}  {hier_path['path_R']:>24.4f}")
    print(f"{'Expected Run Length (ERL, um)':<32} {base_path['erl_um']:>14.1f}  {geo_path['erl_um']:>16.1f}  {multi_path['erl_um']:>18.1f}  {hier_path['erl_um']:>24.1f}")
    print("-" * 120)
    print(f"{'Line Graph Precision (P_line)':<32} {base_lg.pre_only.precision:>14.4f}  {geo_lg.pre_only.precision:>16.4f}  {multi_lg.pre_only.precision:>18.4f}  {hier_lg.pre_only.precision:>24.4f}")
    print(f"{'Line Graph Recall (R_line)':<32} {base_lg.pre_only.recall:>14.4f}  {geo_lg.pre_only.recall:>16.4f}  {multi_lg.pre_only.recall:>18.4f}  {hier_lg.pre_only.recall:>24.4f}")
    print(f"{'Line Graph F1 (F1_line)':<32} {base_lg.pre_only.f1:>14.4f}  {geo_lg.pre_only.f1:>16.4f}  {multi_lg.pre_only.f1:>18.4f}  {hier_lg.pre_only.f1:>24.4f}")
    print(f"{'Line Graph TP Edges':<32} {base_lg.pre_only.tp:>14d}  {geo_lg.pre_only.tp:>16d}  {multi_lg.pre_only.tp:>18d}  {hier_lg.pre_only.tp:>24d}")
    print(f"{'Line Graph FP Edges':<32} {base_lg.pre_only.fp:>14d}  {geo_lg.pre_only.fp:>16d}  {multi_lg.pre_only.fp:>18d}  {hier_lg.pre_only.fp:>24d}")
    print(f"{'Line Graph FN Edges':<32} {base_lg.pre_only.fn:>14d}  {geo_lg.pre_only.fn:>16d}  {multi_lg.pre_only.fn:>18d}  {hier_lg.pre_only.fn:>24d}")
    print("=" * 120)


if __name__ == "__main__":
    run_definitive_benchmark()
