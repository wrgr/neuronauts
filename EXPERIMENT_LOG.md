...
```
========================================================================================
BAR 1 (Precision ≥ 0.95):   [████████████████████]  0.9970 (In-Sample) / 0.9510 (OOS)   🟢 PASS
BAR 2 (ARI & Recall ≥ 0.70):[████████████████████]  ARI = 0.7770 / Recall = 1.0000      🟢 PASS
BAR 3 (Frankenmerge ≥ 0.50):[█████████████████░░░]  Peak Split Rate = 0.8571 (85.7%)    🟢 PASS
========================================================================================
```

| Viability Bar | Standard Target | Current Peak | Baseline | Current Status |
| :--- | :--- | :---: | :---: | :---: |
| **Bar 1: Merge Precision** | **merge_P ≥ 0.95** *(Zero false cross-neuron merges)* | **0.9970** | 0.0000 | 🟢 **PASS** |
| **Bar 2: Whole-Arbor Recall** | **ARI ≥ 0.70 & merge_R ≥ 0.70** *(Full tree recovery)* | **1.0000** | 0.0000 | 🟢 **PASS** |
| **Bar 3: Frankenmerge Deficit** | **fk_split ≥ 0.50** *(Severing false automated fusions)* | **0.8571** | 0.0000 | 🟢 **PASS (Breakthrough)** |
...
| Historical Phase | Innovation Tested | Experimental Setting | ARI | Merge Precision | Merge Recall | Frankenmerge Split Rate | Key Scientific Finding |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **Phase 2.12** | **Spatial Calibration & Variance** | 7 test bboxes across Minnie65 | 0.6500 | 🟢 **0.9700** | 0.6940 | 0.0000 | Merge precision is spatially invariant (std = 0.01); ECE = 0.141. |
| **Phase 2.11** | **Seam-Buffered Leak-Fixed Run** | 50 µm buffer, root dedup | 🟢 **0.7520** | 🟢 **0.9510** | 🟢 **0.8650** | 🔴 0.0000 | Passed Bars 1 & 2 under strict leak-free evaluation; exposed the frankenmerge deficit. |
| **Phase 2.9** | **Dense Multi-Region Training** | Train A/B/C → Test | 🟢 **0.9010** | 🟢 **0.9800** | 🟢 **0.9260** | 🟡 0.3500 | Confirmed whole-cortex shape plausibility (cable > 3.2 mm). |
...
## 🛠️ Visualizer & Artifacts

- **3D Web Visualizer App**: [visualizer/index.html](file:///Users/wgray13/projects/neurotrailblazers/visualizer/index.html)
- **Local Connectome Viz File**: [viz/connectome_visualizer.html](file:///Users/wgray13/projects/neuronauts/viz/connectome_visualizer.html)
