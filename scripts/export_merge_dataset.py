#!/usr/bin/env python3
"""Export a local merge-supervision dataset from MICRONS/CAVE boxes."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="data/merge_dataset.npz", help="Output dataset path.")
    parser.add_argument(
        "--box-indices",
        default="0,1,2",
        help="Comma-separated indices into neuronauts.run.REAL_BOXES.",
    )
    parser.add_argument("--min-fragment-size", type=int, default=2)
...
def main() -> int:
    ...
    for box_idx in indices:
        ...
        box_examples = build_merge_examples_for_box(
            box,
    ...
    save_merge_examples_npz(args.output, examples)
